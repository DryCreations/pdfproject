...
/**
 * @author Cassandra Mae \defgroup Rectangle
 * @{ \ref t18_1 "task 18.1" \brief This class creates a rectangle shape in
 *    order to demonstrate the selection operation.
 */
public class ShapeRectangle extends Shape {
	...
	/**
	 * \brief Draws the rectangle shape \ref t18_1 "task 18.1" Draws a rectangle
	 * which can be selected by the selection tool.
	 */
	@Override
	...
	/**
	 * \ref t18_1 "task 18.1" \brief highlights the rectangle when it is selected.
	 */
	@Override
	...
	/// \ref t18_2 "task 18.2"
	/// \brief Highlights the shape if link is provided to that shape
	@Override
	public void HighlightLinkedShape(GraphicsContext gc) {
		// TODO Auto-generated method stub
		javafx.scene.shape.Rectangle bound = getBound();
